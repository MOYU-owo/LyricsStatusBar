...
Lyrics StatusBar interoperates with, but does not bundle, BetterNCM. BetterNCM is available under GPL-3.0 from:

https://github.com/std-microblock/chromatic/tree/v2

The optional BetterNCM installer is available under GPL-3.0 from:
...
Inno Setup is used only to compile the installer:
